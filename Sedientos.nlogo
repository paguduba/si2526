...
to charcos
  ...
  repeat charcos_numero [
    set cordx random-pxcor
    set cordy random-pycor
    ask patches with [pycor = cordy and pxcor = cordx] [ set pcolor blue set plabel "agua" ]
  ]

end

to criaturas
  crt criaturas_numero[
    set label who
    set color red
...
to moverse
  ...
  while [continuar = true][
    ask turtles with [vida = true] [
      ...
      set sed sed - (random 2 )

      if [plabel] of patch-here = "agua" and sed < 70 [set sed sed + 30 show (word "BEBE  " sed )]
